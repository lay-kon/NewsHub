...
-- Insert admin
INSERT INTO administradores (primeiro_nome, ultimo_nome, email, username, senha, pin) VALUES ('Admin', 'NewsHub', 'admin@newshub.com', 'admin', '$2a$10$examplehashedpassword', '1234');

-- Insert autores
INSERT INTO leitorAutores (primeiro_nome, ultimo_nome, email, username, senha, biografia) VALUES 
('João', 'Silva', 'joao@newshub.com', 'joaosilva', '$2a$10$examplehashedpassword', 'Jornalista experiente.'),
('Maria', 'Santos', 'maria@newshub.com', 'mariasantos', '$2a$10$examplehashedpassword', 'Especialista em tecnologia.');
